...
class TechCrunchScraperTestCase(TestCase):
    ...
    @patch('requests.get')
    def test_tc_extr_author(self, mock_get):
        """
        ...
        author = self.scraper.extract_author_from_page(parsed_article)
    ...
    def test_tc_extr_author_wrong_url(self, mock_get1, mock_get2):
        """
        ...
        author = self.scraper.extract_author(parsed_author)
    ...
    @patch('requests.get')
    def test_tc_extr_articles(self, mock_get):
