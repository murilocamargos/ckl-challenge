...
class OutletViewTestCase(TestCase):
    ...
    def test_update_outlet_unlogged(self):
        """Test if an unlogged user can delete an outlet."""
        data = {'name': 'Gizmodo'}
    ...
    def test_retrieve_outlet_unlogged(self):
    ...
    def test_update_outlet_logged(self):
    ...
    def test_delete_outlet_logged(self):
        """Test if an logged user can delete an outlet."""
        self.client.force_authenticate(user=self.user)
    ...
    def test_add_outlet_logged(self):
